    ...
    const string RDKMediaEngine::Initialize(PluginHost::IShell* service)
        {
            ...
            if ((_mediaEngine != nullptr) && (_service != nullptr)) {
                ...
                if (subSystem != nullptr) {
                    if (subSystem->IsActive(PluginHost::ISubSystem::STREAMING) == true) {
                        //TODO: always here - Streamer as well
                        SYSLOG(Logging::Startup, (_T("RDK Media Enigne is not defined as External !!")));
                    } else {
        ...
        /* virtual */ void RDKMediaEngine::Deinitialize(PluginHost::IShell* service)
        {
            SYSLOG(Trace::Error, (_T("Deinitialize ")));
        ...
        /* virtual */ string RDKMediaEngine::Information() const
        {
            // No additional info to report.
            SYSLOG(Trace::Error, (_T("Information() ")));
            return (string());
        }
        ...
        void RDKMediaEngine::Deactivated(RPC::IRemoteConnection* connection)
        {
            ...
            if (_connectionId == connection->Id()) {
                SYSLOG(Trace::Error, (_T("Deactivating()")));
                ASSERT(_service != nullptr);
